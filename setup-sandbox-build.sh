...
echo ""
echo "Note: bukkit-helper-121-10 may fail if Spigot 1.21.10-R0.1-SNAPSHOT is not yet in public Maven repos"
echo "To skip it: ./gradlew setup build -x :bukkit-helper-121-10:compileJava -x :bukkit-helper-121-10:build"
